...
public class StreamingResolutionResultBuilder implements DependencyGraphVisitor {
    ...
    public StreamingResolutionResultBuilder(BinaryStore store, Store<ResolvedComponentResult> cache, ImmutableModuleIdentifierFactory moduleIdentifierFactory, ImmutableAttributesFactory attributesFactory) {
        this.componentResultSerializer = new ComponentResultSerializer(moduleIdentifierFactory, new AttributeContainerSerializer(attributesFactory));
        this.store = store;
        this.cache = cache;
